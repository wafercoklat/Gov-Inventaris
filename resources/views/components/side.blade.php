<div class="side-menu-fixed">
    <div class="scrollbar side-menu-bg">
        <ul class="nav navbar-nav side-menu" id="sidebarnav">
            ...
            <li> <a href="{{url('Kondisi')}}"><i class="fa fa-user-circle-o"></i><span class="right-nav-text">Lapor Barang</span></a> </li>
            <li> <a href="{{url('Daftar-Barang-Rusak')}}"><i class="fa fa-user-circle-o"></i><span class="right-nav-text">Daftar Barang Rusak</span></a> </li>
